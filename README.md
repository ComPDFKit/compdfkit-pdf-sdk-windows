...
Then, add the following code to MainWindow.xaml and MainWindow.xaml.cs to display a PDF document. It’s really easy to present a PDF on screen. All you need is to create a `CPDFDocument` object.
