...
So far, we have added ***"ComPDFKit.Desk.dll"***, ***"ComPDFKit.Viewer.dll"*** and ***"ComPDFKit.dll"*** to the ***"PdfViewer"*** project, and finished the initialization of the ComPDFKit.
