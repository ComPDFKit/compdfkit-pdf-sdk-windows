...
namespace ComPDFKit.Controls.Annotation.PDFAnnotationPanel.PDFAnnotationUI
{
    public partial class CPDFCreateStampDialog : Window
    {
        ...
        {
            C_STAMP_TYPE Type = C_STAMP_TYPE.UNKNOWN_STAMP;
            switch (CreateHeader.SelectedIndex)
            {
                case 0:
                    Type = C_STAMP_TYPE.TEXT_STAMP;
                    break;
                case 1:
                    Type = C_STAMP_TYPE.IMAGE_STAMP;
                    break;
                default:
                    break;
            }
        ...
        private void CretaeStampData(C_STAMP_TYPE Type)
        {
            switch (Type)
            {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            ShapeBoxbinding.Path = new PropertyPath("ShapeBoxList");
            ShapeBox.SetBinding(ItemsControl.ItemsSourceProperty, ShapeBoxbinding);
        ...
        private void Grid_Drop(object sender, DragEventArgs e)
        {
            ...
            {
                string FileType = Path.GetExtension(f).Trim().ToLower();
